...
public class Config {
	...
	public static boolean DrawSightInfo = false; 
	...
	public static int maxNumberOfTrainUnitType3AgainstProtoss = 0;  // 럴커
	public static int maxNumberOfTrainUnitType4AgainstProtoss = 0;  // 뮤탈
	public static int maxNumberOfTrainUnitType5AgainstProtoss = 0;  // 울트라
	...
	public static int maxNumberOfTrainUnitType3AgainstZerg = 0;  // 럴커
	public static int maxNumberOfTrainUnitType4AgainstZerg = 0;  // 뮤탈
	public static int maxNumberOfTrainUnitType5AgainstZerg = 0;  // 울트라
	...
	public static int maxNumberOfTrainUnitType3AgainstTerran = 0;  // 럴커
	public static int maxNumberOfTrainUnitType4AgainstTerran = 0;  // 뮤탈
	public static int maxNumberOfTrainUnitType5AgainstTerran = 0;  // 울트라
	...
	// 봇 이름 및 파일 경로 기본값 변경
	/// 봇 이름
	public static final String BotName = "KC91";
	/// 봇 개발자 이름
	public static final String BotAuthors = "KC91";
